...
routes.get('/process', validate, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const out = yield (0, imageProcess_1.default)(req.query.filename, req.query.width == undefined ? undefined : +req.query.width, req.query.height == undefined ? undefined : +req.query.height);
        res.sendFile(out);
    }
    catch (error) {
